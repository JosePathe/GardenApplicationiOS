...
public class Troc: NSObject {
    ...
    */
    public init(json: JSON) {
		...
		trocUserAccept = json[kTrocTrocUserAcceptKey].int
    ...
    */
    ...
    required public init(coder aDecoder: NSCoder) {
		...
		self.trocUserAccept = aDecoder.decodeObjectForKey(kTrocTrocUserAcceptKey) as? Int
